            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    <?php 
                      ...
                      $cate = "SELECT * FROM user WHERE user_id = '$aid'";
                  ...
                  $sqli2 = "SELECT * FROM post WHERE post.author = '$aid'";
                  ...
                  if(mysqli_num_rows($result2) > 0){
                    ...
                    if($page > 1){
                        echo "  <li><a href='?aid={$aid}&page=".($page-1)."'>Prev</a></li> ";
                    }
                    for($i = 1; $i<=$pages; $i++){
                        if($i == $page){
                            $active = "active";
                       ...
                       echo "<li class='".$active."'><a href='?aid={$aid}&page=$i'>$i</a></li>";
                    }
                    if($pages > $page){
                         echo "  <li><a href='?aid={$aid}&page=".($page+1)."'>Next</a></li> ";
                    }
